...
#GTC first
GTC_Drivers2$left<-substrLeft(GTC_Drivers2$'PCO Number',4)
GTC_Drivers2$right<-substrRight(GTC_Drivers2$'PCO Number',4)


GTC_Drivers2$PCO2<-gsub('0.0.','',GTC_Drivers2$right)
GTC_Drivers2$PCO_Number<-paste(GTC_Drivers2$left,GTC_Drivers2$PCO2,sep='')


GTC_Final<-GTC_Drivers2[,c(1:3,8)]
...
Lite2$PCO_Number<-paste(Lite2$left,Lite2$PCO2,sep='')

Lite_Final<-Lite2[,c(1:3,10,5,6)]
